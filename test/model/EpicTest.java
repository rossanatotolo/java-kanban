...
class EpicTest {
    ...
    void shouldBeNoIrrelevantSubtaskIdInsideTheEpics() {
        ...
        SubTask subTask1 = new SubTask("Новая подзадача1", "Описание", Status.NEW, 1);
        SubTask subTask2 = new SubTask("Новая подзадача2", "Описание", Status.NEW, 1);
        SubTask subTask3 = new SubTask("Новая подзадача3", "Описание", Status.NEW, 1);
